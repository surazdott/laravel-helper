...
/**
 * Application Helper Fucntion
 *
 * @package :  Laravel Helper
 * @author  :  Suraj Datheputhe (http://surajdatheputhe.com.np/)
 * Copyright (C) 2020-2021 Suraj Datheputhe (surajdatheputhe@gmail.com)
 */
 ...
 * @var $random
 */
function randomNumber($leng='100')
{
    // Random String Function
    $nums = '0123456789';
    $str_len = strlen($nums);
...
/**
 * Embed the Copied URL
 * @var $url
 */
function getEmbedUrl($url) {
    //General function for generating an embed link of an FB/Vimeo/Youtube Video.
    $finalUrl = '';
